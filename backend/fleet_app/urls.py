...
from fleet_app.views.maintenance_views import maintenance_records, vehicle_maintenance_plan
...
urlpatterns = [
    ...
    path('maintenance-plan/<int:vehicle_id>/', vehicle_maintenance_plan),
